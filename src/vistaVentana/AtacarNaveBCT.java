...
public class AtacarNaveBCT extends JFrame {
		/**
	 * 
	 */
	private static final long serialVersionUID = 1L;
		...
		public AtacarNaveBCT(Universo universo, Jugador jugador, ControladorVentana controlador){
			setPreferredSize(new Dimension(272, 140));
			setMinimumSize(new Dimension(272, 140));
			setMaximumSize(new Dimension(272, 140));
			setResizable(false);
			setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
			this.setTitle("Atacar Nave Batalla con Torreta");
			...
			btnCrear.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					controlador.atacarNaveBconTorreta((String)comboBox.getSelectedItem());
			...
			for(Planeta p:universo.mostrarNavesBEnemigasEnOrbita(jugador)){
