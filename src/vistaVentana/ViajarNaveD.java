...
public class ViajarNaveD extends JFrame {
		/**
	 * 
	 */
	private static final long serialVersionUID = 1L;
		...
		public ViajarNaveD(Universo universo, Jugador jugador, ControladorVentanas controlador){
			setPreferredSize(new Dimension(272, 140));
			setMinimumSize(new Dimension(272, 200));
			setMaximumSize(new Dimension(272, 200));
			setResizable(false);
			setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
			this.setTitle("Enviar Nave Destructora");
			...
			for(Planeta p:universo.mostrarPlanetasConND(jugador)){
			...
			btnEnviar.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					controlador.enviarNaveDestructora((String)comboBoxOrigen.getSelectedItem(), (String)comboBoxDest.getSelectedItem());
