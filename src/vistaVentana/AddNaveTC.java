...
public class AddNaveTC extends JFrame {
		/**
	 * 
	 */
	private static final long serialVersionUID = 1L;
		...
		public AddNaveTC(Universo universo, Jugador jugador, ControladorVentanas controlador){
			...
			btnCrear.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					controlador.crearNaveTC((String)comboBox.getSelectedItem());
