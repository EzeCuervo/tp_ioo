...
public class AtacarNaveDCT extends JFrame {
		/**
	 * 
	 */
	private static final long serialVersionUID = 1L;
		...
		public AtacarNaveDCT(Universo universo, Jugador jugador, ControladorVentana controlador){
			setPreferredSize(new Dimension(272, 140));
			setMinimumSize(new Dimension(272, 140));
			setMaximumSize(new Dimension(272, 140));
			setResizable(false);
			setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
			this.setTitle("Atacar Nave Destructora con Torreta");
			...
			btnCrear.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					controlador.atacarNaveDconTorreta((String)comboBox.getSelectedItem());
			...
			for(Planeta p:universo.mostrarNavesDEnemigasEnOrbita(jugador)){
